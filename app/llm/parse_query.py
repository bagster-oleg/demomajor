        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "safety_equipped": {
                    "type": ["boolean", "null"],
                    "description": (
                        "true, если клиент явно говорит про безопасность ('безопасная машина', "
                        "'с хорошей безопасностью', 'побезопаснее'). В базе нет краш-тестов - это "
                        "означает реальное защитное оборудование (ESP, доп. подушки безопасности)."
                    ),
                },
